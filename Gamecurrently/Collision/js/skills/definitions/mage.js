...
export default {
  ...
  category: '剑与魔法',
  skillName: '奥术飞弹',
  desc: '被动【奥术飞弹】(8秒循环)：前5秒每秒在球周围五角星位置生成1颗蓄能飞弹（第5秒集齐5颗并展示1秒），第6秒全部向随机方向发射；每颗飞弹命中敌球造成5点伤害，撞球或边界即消失。发射完进入2秒空窗期后重新积累。游走远程，飞弹会自己找人！',
  color: '#B89FEA',
  passive: {
  ...
  effects: [{
    ...
    onUpdate(b, dt, st, ctx) {
      ...
      if (!p.fired) {
        ...
        // 第6秒（fireTime）：全部发射（随机方向）——与集齐（chargeTime=5）间隔1秒
